...
def mask_data():
    ...
    if selected_category == "ALL":
        ...
        # Mask PII entities based on selected category
        pii_entities = detect_pii_entities(document_content)
        # Filter entities based on category
        pii_entities = [entity for entity in pii_entities if entity.category == selected_category]
